      ...
      * PROGRAM LOGIC CONTROL CENTER, THE HIGHEST LEVEL
       100-CREATE-INVENT-REORDER-REPORT.
           ...
           PERFORM 300-WRITE-REORDER-HEADLINE-RECORD.
           PERFORM 300-SEARCH-INV-RECORD-WRITE-REORDER-RECORD           
               UNTIL EOF-INVENT = "YES".
      ...
      * WRITE THE REORDER REPORT RECORD
       300-SEARCH-INV-RECORD-WRITE-REORDER-RECORD.               
           READ INVENT-FILE-IN
               AT END MOVE "YES" TO EOF-INVENT
               NOT AT END
      ...
      *WRITE REORDER RECORDER HEADER        
       300-WRITE-REORDER-HEADLINE-RECORD.
